...
try {
	...
	$DB_HANDLE->exec($sql);
	$sql = "USE camagru;
		CREATE TABLE `camagru`.`users` ( `id` INT NOT NULL AUTO_INCREMENT , `email` TEXT NOT NULL , `username` TEXT NOT NULL , `password` TEXT NOT NULL , `token` TEXT , PRIMARY KEY (`id`)) ENGINE = InnoDB;
